...
making the call. Set `max_tokens` for a hold that is a true maximum: without
it, 4,096 output tokens are assumed and a longer answer settles above the
hold. The real cost is recorded either way. Here, a limit far too small:
