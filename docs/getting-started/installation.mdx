...
These docs describe 0.4.0 and later. If it says 0.3.x, see *An older version was
installed* below.
...
<AccordionGroup>
  <Accordion title="An older version was installed">
    OmniCoreAgent 0.4.0 needs Python 3.12 or later. On Python 3.11, pip does not
    fail: it quietly installs **0.3.9**, the last release that supported 3.11 —
    and nothing in these docs works with it.
