---
title: OmniCoreAgent
description: 'The SDK entry point: one object for the model, loop, tools, memory, workspace, guardrails and runtime options'
icon: 'robot'
---

# OmniCoreAgent

`OmniCoreAgent` is the SDK's entry point to the runtime and harness. It wraps a model with
