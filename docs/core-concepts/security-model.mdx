...
<Card title="Policy reference" icon="shield-halved" href="/docs/reference/policy">
  Every capability and what it lets the agent do, how a request is decided
  (deny, then ask, then allow, then the mode), how to write a rule, and every
  rule of each built-in profile.
</Card>
