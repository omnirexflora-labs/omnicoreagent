...
| G4 | Done | `G4_COMMIT` | `docs/core-concepts/guardrails.mdx` rewritten: what it is (a screen for injection phrasing, not the security boundary), what counts as evidence and what does not, the modes, the corpus. |
