...
| 10 | [agent_with_context_management.py](./agent_with_context_management.py) | **🆕 Context Management**: Keep long conversations within a configured context budget |
| 11 | [agent_with_guardrails.py](./agent_with_guardrails.py) | **🆕 Guardrails**: Protect against prompt injection |
| 12 | [agent_with_metrics.py](./agent_with_metrics.py) | **🆕 Metrics**: Track tokens, requests, and latency |
